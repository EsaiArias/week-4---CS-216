...
/*Write a loop to call setScores for each student in the students_ap array.*/
  ...
  /*Write a loop to call showScores for each student in the students_ap array.*/
  for (int i = 0; i < AP_STUDENTS; i++)
    {
  ...
  /*Write a loop to call updateName for each student in the students array.*/
  for (int i = 0; i < NBR_STUDENTS; i++)
    students[i].updateName();
  
  cout << "Enter scores for non-AP students\n";
  /*Write a loop to call setScores for each student in the students array.*/
  for (int i = 0; i < NBR_STUDENTS; i++)
    {
  ...
  /*Write a loop to call showScores for each student in the students array.*/
  for (int i = 0; i < NBR_STUDENTS; i++)
    {
...
Enter first name for student 103: Esai
Enter last name for student 103: Arias
Enter first name for student 104: Jacob
Enter last name for student 104: Johnson
Enter first name for student 105: Tim
Enter last name for student 105: Duncan
Enter scores for non-AP students
Enter score 1 for student 103: Esai Arias
98
Enter score 2 for student 103: Esai Arias
97
Enter score 3 for student 103: Esai Arias
96
Enter score 4 for student 103: Esai Arias
95
...
84
Enter score 1 for student 105: Tim Duncan
76
Enter score 2 for student 105: Tim Duncan
75
Enter score 3 for student 105: Tim Duncan
74
Enter score 4 for student 105: Tim Duncan
73
Show scores for non-AP students
Scores for student 103: Esai Arias are
98 97 96 95 
The average is: 96
Scores for student 104: Jacob Johnson are
87 86 85 84 
The average is: 85
Scores for student 105: Tim Duncan are
76 75 74 73 
The average is: 74
